...
class Game:
    ...
    def reset_game(self):
        #Resets the game, keeping score and color intact
    ...
    def reset_actions(self):
        if self.turn.lower() == "white":
            self.actions["white"] = 1
        elif self.turn.lower() == "black":
            self.actions["black"] = 1
